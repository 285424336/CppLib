...
#include <kernel32\Kernel32Helper.h>       // std::vector
...
RegKey CreateKey(HKEY hKey, const std::wstring& subKeyName,
    DWORD options = 0, REGSAM accessRights = KEY_WRITE | KEY_READ | (Kernel32Helper::Is64System() ? KEY_WOW64_64KEY : 0),
...
void DeleteKey(HKEY hKey, const std::wstring& subKey, REGSAM view = (Kernel32Helper::Is64System() ? KEY_WOW64_64KEY : KEY_WOW64_32KEY));
